    ...
    <main className="min-h-screen bg-stone-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-6 text-stone-100">Create your account</h1>
          <p className="mt-1 text-sm text-stone-500">Free to start. Every feature included.</p>
        </div>
